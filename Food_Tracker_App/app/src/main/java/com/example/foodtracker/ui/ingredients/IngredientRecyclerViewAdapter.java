...
public class IngredientRecyclerViewAdapter extends RecyclerView.Adapter<IngredientRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.relativeLayout.setOnClickListener(v -> holder.expandIngredient.setVisibility(holder.expandIngredient.getVisibility() == View.VISIBLE ? View.GONE : View.VISIBLE));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            deleteIngredient.setOnClickListener(v -> {
                ...
                Ingredient ingredient = ingredientArrayList.get(adapterPosition);
